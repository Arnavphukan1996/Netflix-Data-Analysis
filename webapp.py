...
st.write("Click on the Dataset Overview Option to see indepth analysis of the dataset")
...
if option_9:
    ...
    data=load1_data()
    ch=st.sidebar.checkbox("Show Original Data")
    print(ch)
    if ch:
    ...
    data=load_data()
    ch1=st.sidebar.checkbox("Show Machine Generated Data")
    print(ch1)
    if ch1:
